Feature: Load Repose Plugin Page
	...
	Scenario: Stop sysstats main load test with jmeter for 60 minutes with Sysstats data stored
		...
		And the "data/sysstats_plugin" directory should contain "sysstats_cpu.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_kernel.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_device_disk.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_device_failure.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_ip_failure_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_ip_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_tcp_failure_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_tcp_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_memory_page.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_memory_swap.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should contain "sysstats_memory_utilization.out_10.23.246.101" result file
	...
	Scenario: Stop sysstats main load test with jmeter for 60 minutes with invalid server
		...
		And the "data" directory should contain "summary.log" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_cpu.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_kernel.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_device_disk.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_device_failure.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_ip_failure_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_ip_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_tcp_failure_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_tcp_network.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_memory_page.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_memory_swap.out_10.23.246.101" result file
		And the "data/sysstats_plugin" directory should not contain "sysstats_memory_utilization.out_10.23.246.101" result file
		And the "request" json entry for "meta" hash key in redis should exist
		And the "response" json entry for "meta" hash key in redis should exist
		And the "script" json entry for "meta" hash key in redis should exist
		And the "meta" directory should contain "test.jmx" result file
