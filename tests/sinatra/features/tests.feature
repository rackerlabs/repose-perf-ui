...
Feature: Test Page
	...
	Scenario: Start recording REPOSE atom_hopper test with custom name, custom description and defaults
		Given I navigate to '/repose/tests/atom_hopper/adhoc_test'
		And Test for "repose" "atom_hopper" "adhoc"
		Then the page should contain "Schedule new test"
		And the page should contain "Test name"
		And the page should not contain "Current Running Test"
		...
		Then the page response status code should be "200"
		And the page should contain "Current Running Test"
		And the page should contain "Schedule new test"
