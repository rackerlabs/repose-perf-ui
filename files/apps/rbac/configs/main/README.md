...
This is where you can find the ever-so-elegant repose configuration templates provided by clouddb-puppet during code deployment

These templates are in ERB format for puppet; if you have any questions about what is 
  referenced in ERB variables, see: https://github.rackspace.com/Cloud-Database/clouddb-puppet


Contents: 
* capabilities.wadl.xml.erb

    capabilities of the system!

* client-auth-n.cfg.xml.erb

    how we auth!

* container.cfg.xml.erb

    where we live and store stuff... oh and what log configuration file to use

* content-normalization.cfg.xml.erb

    content is normalized here

* dbaas-request.xsl.erb

    an xsl

* dist-datastore.cfg.xml.erb

    session datastore configuration 
...
* log4j.properties.erb
    ...
    Lets tweak how this beast called repose logs...

* rate-limiting.cfg.xml.erb

    rate limiting definitions because of you.. yes, you caused the limits.

* repose-valve.init.erb

    This was the init script used at one point for dbaas and repose-valve; kept for historical purposes

* response-messaging.cfg.xml.erb

    when you break the rules, you see this

* system-model.cfg.xml.erb

    Repose, you shall look like this...

* translation.cfg.xml.erb

    See jsonx2json.xml.erb

* uri-normalization.cfg.xml.erb

    Normalizing content on the reg

* validator.cfg.xml.erb

    Points to capabilities.wadl.xml... 
>>>>>>> 9328bc00a9117464e8c56f1316a8188a683cacc4
